...
class LetsCalculateUI:
    def __init__(self, window):
        ...
        self.add_button = tk.Button(window, text="+",font=('Arial',12, 'bold'), width=4 ,command=lambda:self.add_sub_function("+"),fg="red", bd=1, relief='solid',highlightbackground="#42f5e6")
        self.add_button.grid(row=6, column=2, pady=9)
        self.add_button.bind("<FocusOut>",self.update_result)
        
        self.sub_button = tk.Button(window, text="-",font=('Arial',12, 'bold'), width=4,command=lambda:self.add_sub_function("-"),fg="red", bd=1, relief='solid',highlightbackground="#42f5e6")
